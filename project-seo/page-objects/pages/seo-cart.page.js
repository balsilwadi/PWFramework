...
class SeoCartPage {
   ...
   * @returns : None
   * */
  async verifyCanonicalUrl(cartPageUrl) {
    ...
    expect(actualCanonicalUrl).toContain(env.SEO_CANONICAL_OG_URL + cartPageUrl);
  ...
  async verifyOgUrl(cartPageUrl) {
    ...
    expect(actualOgUrl).toContain(env.SEO_CANONICAL_OG_URL + cartPageUrl);
  ...
  async verifySeoHeader1Tag() {
    ...
    const actualHeader1Tag = await page.locator(el.seoCartPage.seoHeader1Tag).textContent();
