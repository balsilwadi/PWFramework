...
class SeoSpategoryPage {
   ...
   * @returns : None
   * */
  async verifyCanonicalUrl(spCategoryURL) {
    ...
    expect(actualCanonicalUrl).toContain(env.SEO_CANONICAL_OG_URL + spCategoryURL);
   ...
   * @returns : None
   * */
  async verifyOgUrl(spCategoryURL) {
    ...
    expect(actualOgUrl).toContain(env.SEO_CANONICAL_OG_URL + spCategoryURL);
  ...
  async verifySeoHeader1Tag() {
    ...
    const actualHeader1Tag = await page.locator(el.seoSpategoryPage.seoHeader1Tag).textContent();
...
module.exports = { SeoSpategoryPage };
